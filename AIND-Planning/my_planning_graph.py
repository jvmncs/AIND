...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        for action_node in self.a_levels[level-1]:
            # Only consider literals that are possible given the previous level's actions
            for node in action_node.effnodes:
                # Add node and make chilren and parent connections
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Inconsistent effects occur when the nodes add and remove the same literals.
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Interference occurs when the effect of one node is the negation of the other node's precondition.
        for effect in node_a1.action.effect_add:
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        '''
        # Modified from PgNode_s.__eq__ method
